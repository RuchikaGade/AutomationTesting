...
//In order to handle any java Script pop up we need to use driver,switchTo().alert()
  // bczjava script pop up doesn't contain HTML code
//We use predefined Functions of alert tp perform  any operation on it  
