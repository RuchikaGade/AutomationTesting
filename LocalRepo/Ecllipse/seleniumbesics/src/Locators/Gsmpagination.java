...
public class Gsmpagination {
	...
	public static void main(String[] args)  throws InterruptedException{
		...
		driver.get("https://www.gsmarena.com/vivo-phones-98.php");
		List<WebElement>paginationlinks=driver.findElements(By.cssSelector(".nav-pages"));
		System.out.println("size:"+paginationlinks.size());
		...
		for(WebElement element:paginationlinks) {//print Links
			...
			for(int i=0;i<paginationlinks.size();i++) {
				...
				//paginationlinks=driver.findElements(By.cssSelector("a[href=techno-phones-120.php]"));
			}
		}
	}
