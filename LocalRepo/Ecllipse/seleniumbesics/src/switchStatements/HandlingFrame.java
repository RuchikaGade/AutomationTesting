...
//WebElement frameobject=driver.findElement(By.cssSelector("");
...
//in order to perform any reqquired action on the main page element switch back to main page first
